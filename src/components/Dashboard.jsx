  ...
  useEffect(() => {
    const handleDocumentClick = (event) => {
      if (
        ...
        !event.target.closest("button[aria-controls='logo-sidebar']")
      ) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a className="flex ms-2 md:me-24">
                <img
                  src={logo}
                  className="me-3 rounded-full h-20 w-24"
                  alt="FlowBite Logo"
                />
              </a>
            </div>
                ...
                <Dropdown>
                  ...
                  <DropdownMenu aria-label="User Menu" variant="light">
                    ...
                    <DropdownItem
                      ...
                      className="mt-1 hover:bg-red/20"
                      key="logout"
                      onPress={handleLogout}
                    >
                      <p className="font-normal text-red ml-20">
                        Cerrar Sesión
                      </p>
                    </DropdownItem>
                  </DropdownMenu>
