 ...
 * @param {string} props.config.filterByRequirement - Current value of the original requirement name filter.
            ...
            <div className="flex flex-col gap-4 mb-4">
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4">
                    ...
                    <Input
                        ...
                        startContent={<img src={search_icon} alt="Buscar" className="w-4 h-4" />}
                        onClear={onClear}
                    ...
                    <Input
                        ...
                        startContent={<img src={search_icon} alt="Buscar" className="w-4 h-4" />}
                        onClear={onClear}
                        onValueChange={onFilterByRequirement}
                    />
