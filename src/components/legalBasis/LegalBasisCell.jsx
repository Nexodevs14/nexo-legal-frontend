 ...
 * @param {Function} props.openReqIdentificationModal - Function to open the requirement identification modal.
            ...
            <Dropdown>
              ...
              >
                ...
                <DropdownItem
                  ...
                  onPress={() => openReqIdentificationModal(legalBase)}
                >
...
LegalBasisCell.propTypes = {
  ...
  openReqIdentificationModal: PropTypes.func,
};
